      ...
      {dates.map(date => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center min-w-[70px] p-4 rounded-2xl border transition-all duration-300 relative ${
              isSelected 
    ...
    try {
      ...
      try {
        const res = await ai.models.generateContent({ 
          ...
          contents: `Input Data: ${JSON.stringify(initialResult.tours.map(t => ({ d: t.driverName, s: t.orders.map(o => ({ n: o.name, a: o.address, p: o.postCode, ar: o.area })) })))}`,
          config: {
            systemInstruction: `TASK: Validate and refine delivery sequences.
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                <div className="lg:col-span-8 bg-slate-900 p-8 rounded-[2.5rem] border border-white/5 shadow-2xl">
                  <div className="flex justify-between items-center mb-6">
                      ...
                      <div className="text-[10px] font-bold text-emerald-400 uppercase bg-emerald-500/5 px-4 py-1.5 rounded-full border border-emerald-500/20">10:00 AM START -> 12:30 PM DEADLINE</div>
                  </div>
